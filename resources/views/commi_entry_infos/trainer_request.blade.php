    ...
    <div class="content px-3">
        ...
        <div class="uk-card uk-card-default uk-card-body uk-width-1-2@m">
            ...
            <form method="POST" action="{{ route('trainer_request_send') }}">
                ...
                @if ($userinfo->trainer_sent_at)
                    <span class="uk-text-warning uk-text-small">{{ $userinfo->trainer_sent_at }}に送信済み</span>
                @endif
                <input type="submit" value="{{ $userinfo->trainer_sent_at ? '再度依頼する' : '依頼する' }}"
