...
<p>
    あなたが申し込みをされました指導者訓練について、参加が決定いたしましたのでお知らせいたします。<br>
    下記URLより参加案内を確認のうえ、ご参加ください。<br>
    また、万が一、参加を取りやめる場合は、速やかに<a href="mailto:ais@scout.tokyo">東京連盟事務局</a>までご連絡ください。
</p>
...
@if (isset($sc_number))
    ...
    @elseif($sc_number == 30)
        {{-- SC30のリンク --}}
        <a
            href="https://drive.google.com/file/d/1YpsKgXc8BV4c5c6Yuq3KpQS5rpMF9OoU/view?usp=sharing">SC{{ $sc_number }}期の参加案内を表示する</a><br>
...
@if (isset($division_number))
    ...
    @if ($division_number == 'BVS14')
        <a
            href="https://drive.google.com/file/d/13zOJ4_Ak5jvthmUq-ztKLfGx5pvv3j5f/view?usp=drive_link">参加決定通知書(BVS課程東京第14回)</a>
    @elseif ($division_number == 'CS14')
        <a
            href="https://drive.google.com/drive/folders/1yRejlonJMk7mFF48TNj9ar3xHfJBoSgg?usp=sharing">参加決定通知書、関係資料(CS課程東京第14回)</a>
    @elseif ($division_number == 'BS14')
        <a
            href="https://drive.google.com/file/d/11IdLh6wqeo8xxcKSDdg7-AlfmQ4GZtdj/view?usp=drive_link">参加決定通知書(BS課程東京第14回)</a>
    @elseif ($division_number == 'VS14')
        <a
            href="https://drive.google.com/file/d/15vZdQ7LvOznTVw3wkjJB1fMz7bbQacZT/view?usp=drive_link">参加決定通知書(VS課程東京第14回)</a><br>
        <a href="{{ url('/download/VS14_worksheet.docx') }}">事前課題(wordファイル)</a>
    @endif
@endif

<p>
    なお、納期限までに入金が確認できない場合は、参加を取り消しますので、予めご承知おきください。<br>
